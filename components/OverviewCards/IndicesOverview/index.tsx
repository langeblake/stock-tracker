      ...
      <div className="container">
        <div>
          {indicesData.slice(0, 2).map((indexData, idx) => (
            ...
            indexData ? (
              <div key={idx} className=" min-w-[300px] flex flex-col shadow-lg rounded-lg p-4 border dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div className="flex flex-col gap-10 font-light">
                  ...
                  <div className='flex justify-between gap-4'>
                    ...
                    <div className={`${indexData.results[0]?.c > indexData.results[1]?.c ? 'text-green-500' : 'text-red-500'}`}>{((indexData.results[0]?.c ?? 0) - (indexData.results[1]?.c ?? 0)).toFixed(2)}</div>
