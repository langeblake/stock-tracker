              ...
              <div key={idx} >
                ...
                <div className="flex flex-col gap-10">
                  ...
                  <div className='flex justify-between gap-4'>
                    ...
                    <div className={`font-light ${indexData.results[0]?.c > indexData.results[1]?.c ? 'text-green-500' : 'text-red-500'}`}>{((indexData.results[0]?.c ?? 0) - (indexData.results[1]?.c ?? 0)).toFixed(2)}</div>
