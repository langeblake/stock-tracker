              ...
              <TableRow key={headerGroup.id} className="border-zinc-600 ">
                {headerGroup.headers.map((header) => {
                  return (
                    <TableHead
                      key={header.id}
                      className={`${header.id === "favorite" ? "sticky text-transparent left-0 z-4 px-[13px] w-20 dark:bg-zinc-900 bg-zinc-200" : header.id === "symbol" ? "sticky left-[80px] z-1 pl-3 pr-10 dark:bg-zinc-900 bg-zinc-200 text-left " : "text-right w-40"}`}
                    >
                  ...
                  {row.getVisibleCells().map((cell) => (
                    ...
                    ${
                      ...
                      cell.column.id === "symbol"
                        ? "group-hover:dark:bg-zinc-900 group-hover:bg-zinc-200 dark:bg-black sticky-column " +
                          cell.column.id
                        : "pr-10 "
                    }`}
                    >
