            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  We're currently working hard to enhance user experience with
                  powerful features for in-depth stock tracking. <br /> Stay
                  tuned for updates! <br /> For now, please track all your
                  favorite stocks from the Homepage.
                </p>
                <Link
                  href="/"
